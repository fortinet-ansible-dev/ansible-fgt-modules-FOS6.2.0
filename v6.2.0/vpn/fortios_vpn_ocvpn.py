...
def filter_vpn_ocvpn_data(json):
    option_list = ['auto_discovery', 'eap', 'eap_users',
                   'ha_alias', 'nat', 'overlays',
                   'poll_interval', 'role', 'status']
    dictionary = {}
...
def main():
    fields = {
        ...
        "vpn_ocvpn": {
            ...
            "options": {
                "auto_discovery": {"required": False, "type": "str",
                                   "choices": ["enable", "disable"]},
                "eap": {"required": False, "type": "str",
                        "choices": ["enable", "disable"]},
                "eap_users": {"required": True, "type": "str"},
                "ha_alias": {"required": False, "type": "str"},
                "nat": {"required": False, "type": "str",
                        "choices": ["enable", "disable"]},
                "overlays": {"required": True, "type": "list",
                             "options": {
