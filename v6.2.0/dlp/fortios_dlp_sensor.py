...
def filter_dlp_sensor_data(json):
    option_list = ['comment', 'dlp_log', 'extended_log',
                   'filter', 'full_archive_proto', 'nac_quar_log',
                   'name', 'options', 'replacemsg_group',
                   'summary_proto']
    dictionary = {}
...
def dlp_sensor(data, fos):
    ...
    if 'state' in data and data['state']:
        state = data['state']
    elif 'state' in data['dlp_sensor'] and data['dlp_sensor']['state']:
            ...
            "options": {
                ...
                "filter": {"required": False, "type": "list",
                           "options": {
                               ...
                               "sensitivity": {"required": False, "type": "list",
                                               "options": {
