...
def filter_vpn_ssl_settings_data(json):
    option_list = ['algorithm', 'auth_session_check_source_ip', 'auth_timeout',
                   ...
                   'dns_suffix', 'dtls_hello_timeout', 'dtls_tunnel',
                   'force_two_factor_auth', 'header_x_forwarded_for', 'http_compression',
                   'http_only_cookie', 'http_request_body_timeout', 'http_request_header_timeout',
                   'https_redirect', 'idle_timeout', 'ipv6_dns_server1',
                   'ipv6_dns_server2', 'ipv6_wins_server1', 'ipv6_wins_server2',
                   'login_attempt_limit', 'login_block_time', 'login_timeout',
                   'port', 'port_precedence', 'reqclientcert',
                   'route_source_interface', 'servercert', 'source_address',
                   'source_address_negate', 'source_address6', 'source_address6_negate',
                   'source_interface', 'ssl_client_renegotiation', 'ssl_insert_empty_fragment',
                   'tlsv1_0', 'tlsv1_1', 'tlsv1_2',
                   'tlsv1_3', 'tunnel_connect_without_reauth', 'tunnel_ip_pools',
                   'tunnel_ipv6_pools', 'tunnel_user_session_timeout', 'unsafe_legacy_renegotiation',
                   'url_obscuration', 'wins_server1', 'wins_server2',
                   'x_content_type_options']
    dictionary = {}
