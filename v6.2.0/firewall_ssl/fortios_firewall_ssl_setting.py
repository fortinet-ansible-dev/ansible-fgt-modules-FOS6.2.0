...
def filter_firewall_ssl_setting_data(json):
    option_list = ['abbreviate_handshake', 'cert_cache_capacity', 'cert_cache_timeout',
                   'no_matching_cipher_action', 'proxy_connect_timeout', 'session_cache_capacity',
                   'session_cache_timeout', 'ssl_dh_bits', 'ssl_send_empty_frags']
    dictionary = {}
    ...
    fields = {
        ...
        "firewall_ssl_setting": {
            ...
            "options": {
                ...
                "cert_cache_capacity": {"required": True, "type": "int"},
                "cert_cache_timeout": {"required": True, "type": "int"},
                "no_matching_cipher_action": {"required": True, "type": "str",
                                              "choices": ["bypass", "drop"]},
                "proxy_connect_timeout": {"required": True, "type": "int"},
                "session_cache_capacity": {"required": True, "type": "int"},
                "session_cache_timeout": {"required": True, "type": "int"},
                "ssl_dh_bits": {"required": True, "type": "str",
                                "choices": ["768", "1024", "1536",
                                            "2048"]},
                "ssl_send_empty_frags": {"required": True, "type": "str",
                                         "choices": ["enable", "disable"]}
