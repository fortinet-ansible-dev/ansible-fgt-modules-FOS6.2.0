...
def filter_endpoint_control_settings_data(json):
    option_list = ['forticlient_disconnect_unsupported_client', 'forticlient_ems_rest_api_call_timeout', 'forticlient_keepalive_interval',
                   'forticlient_sys_update_interval', 'forticlient_user_avatar']
    dictionary = {}
...
def main():
    fields = {
        ...
        "endpoint_control_settings": {
            ...
            "options": {
                "forticlient_disconnect_unsupported_client": {"required": False, "type": "str",
