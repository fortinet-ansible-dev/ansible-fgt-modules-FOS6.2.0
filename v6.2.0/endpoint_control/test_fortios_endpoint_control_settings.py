...
def test_endpoint_control_settings_creation(mocker):
    ...
    expected_data = {
        'forticlient-disconnect-unsupported-client': 'enable',
        'forticlient-ems-rest-api-call-timeout': '4',
        'forticlient-keepalive-interval': '5',
        'forticlient-sys-update-interval': '6',
