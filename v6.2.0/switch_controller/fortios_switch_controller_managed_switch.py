        ...
        suboptions:
            ...
            ports:
                ...
                suboptions:
                    ...
                    export_tags:
                        description:
                            - Configure tag name for FortiSwitch port when exported.
                        type: list
                        suboptions:
                            tag_name:
                                description:
                                    - FortiSwitch port tag name when exported. Source switch-controller.switch-interface-tag.name.
                                type: str
                    export_to:
                        description:
...
def filter_switch_controller_managed_switch_data(json):
    option_list = ['settings_802_1X', 'access_profile', 'custom_command',
                   ...
                   'fsw_wan1_admin', 'fsw_wan1_peer', 'fsw_wan2_admin',
                   'fsw_wan2_peer', 'igmp_snooping', 'max_allowed_trunk_members',
                   'mirror', 'name', 'owner_vdom',
                   'poe_detection_type', 'poe_lldp_detection', 'poe_pre_standard_detection',
                   'ports', 'pre_provisioned', 'staged_image_version',
                   'static_mac', 'storm_control', 'stp_instance',
                   'stp_settings', 'switch_device_tag', 'switch_id',
                   'switch_log', 'switch_profile', 'switch_stp_settings',
                   'type', 'version']
    dictionary = {}
            ...
            "options": {
                ...
                "custom_command": {"required": False, "type": "list",
                                   "options": {
                                       ...
                                       "command_name": {"required": True, "type": "str"}
                                   }},
                ...
                "fsw_wan1_peer": {"required": True, "type": "str"},
                ...
                "poe_lldp_detection": {"required": False, "type": "str",
                                       "choices": ["enable", "disable"]},
                ...
                "ports": {"required": False, "type": "list",
                          "options": {
                              "allowed_vlans": {"required": False, "type": "list",
                                                "options": {
                                                    "vlan_name": {"required": True, "type": "str"}
                                                }},
                              ...
                              "members": {"required": False, "type": "list",
                                          "options": {
                                              "member_name": {"required": True, "type": "str"}
                                          }},
                              ...
                              "speed": {"required": False, "type": "str",
                                        "choices": ["10half", "10full", "100half",
                                                    ...
                                                    "25000full", "50000full", "10000cr",
                                                    "10000sr", "100000sr4", "100000cr4"]},
