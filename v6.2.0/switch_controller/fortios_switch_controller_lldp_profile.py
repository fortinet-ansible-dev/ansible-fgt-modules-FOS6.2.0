...
def filter_switch_controller_lldp_profile_data(json):
    option_list = ['tlvs_802dot1', 'tlvs_802dot3', 'auto_isl',
                   ...
                   'custom_tlvs', 'med_location_service', 'med_network_policy',
                   'med_tlvs', 'name']
    dictionary = {}
            ...
            "options": {
                ...
                "custom_tlvs": {"required": False, "type": "list",
                                "options": {
                                    ...
                                    "oui": {"required": True, "type": "str"},
                                    "subtype": {"required": False, "type": "int"}
                                }},
                "med_location_service": {"required": False, "type": "list",
                                         "options": {
                                             "name": {"required": True, "type": "str"},
                                             "status": {"required": False, "type": "str",
                                                        "choices": ["disable", "enable"]},
                                             "sys_location_id": {"required": False, "type": "str"}
                                         }},
                "med_network_policy": {"required": False, "type": "list",
                                       "options": {
                                           ...
                                           "vlan_intf": {"required": False, "type": "str"}
                                       }},
