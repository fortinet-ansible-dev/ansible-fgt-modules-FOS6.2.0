...
def filter_switch_controller_global_data(json):
    option_list = ['allow_multiple_interfaces', 'custom_command', 'default_virtual_switch_vlan',
                   'disable_discovery', 'https_image_push', 'log_mac_limit_violations',
                   'mac_aging_interval', 'mac_retention_period', 'mac_violation_timer',
                   'sn_dns_resolution']
    dictionary = {}
