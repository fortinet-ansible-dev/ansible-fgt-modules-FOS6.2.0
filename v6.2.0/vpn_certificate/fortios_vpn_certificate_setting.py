...
def filter_vpn_certificate_setting_data(json):
    option_list = ['certname_dsa1024', 'certname_dsa2048', 'certname_ecdsa256',
                   ...
                   'cn_match', 'ocsp_default_server', 'ocsp_option',
                   'ocsp_status', 'ssl_min_proto_version', 'strict_crl_check',
...
def main():
    fields = {
        ...
        "vpn_certificate_setting": {
            ...
            "options": {
                "certname_dsa1024": {"required": True, "type": "str"},
                "certname_dsa2048": {"required": True, "type": "str"},
                "certname_ecdsa256": {"required": True, "type": "str"},
                "certname_ecdsa384": {"required": True, "type": "str"},
                "certname_rsa1024": {"required": True, "type": "str"},
                "certname_rsa2048": {"required": True, "type": "str"},
                ...
                "ocsp_option": {"required": False, "type": "str",
