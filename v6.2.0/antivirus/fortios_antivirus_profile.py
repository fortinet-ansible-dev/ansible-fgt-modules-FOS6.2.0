        ...
        suboptions:
            ...
            http:
                ...
                suboptions:
                    ...
                    av_optimize:
                        description:
                            - Enable/disable AV optimization for this protocol.
                        type: str
                        choices:
                            - disable
                            - enable
...
def filter_antivirus_profile_data(json):
    option_list = ['analytics_bl_filetype', 'analytics_db', 'analytics_max_upload',
                   ...
                   'cifs', 'comment', 'content_disarm',
                   'extended_log', 'ftgd_analytics', 'ftp',
                   'http', 'imap', 'mapi',
                   'mobile_malware_db', 'nac_quar', 'name',
                   'nntp', 'outbreak_prevention', 'pop3',
                   'replacemsg_group', 'scan_mode', 'smtp']
    dictionary = {}
    ...
    fields = {
        ...
        "antivirus_profile": {
            ...
            "options": {
                ...
                "content_disarm": {"required": False, "type": "dict",
                                   "options": {
                                       ...
                                       "detect_only": {"required": False, "type": "str",
                                                       "choices": ["disable", "enable"]},
                                       "office_action": {"required": False, "type": "str",
                                                         "choices": ["disable", "enable"]},
                                       "office_dde": {"required": False, "type": "str",
                                                      "choices": ["disable", "enable"]},
                         ...
                         "options": {
                             ...
                             "archive_log": {"required": False, "type": "str",
                                             "choices": ["encrypted", "corrupted", "partiallycorrupted",
                                                         "multipart", "nested", "mailbomb",
                                                         "fileslimit", "timeout", "unhandled"]},
                             "av_optimize": {"required": False, "type": "str",
                                             "choices": ["disable", "enable"]},
                ...
                "outbreak_prevention": {"required": False, "type": "dict",
                                        "options": {
                                            "external_blocklist": {"required": False, "type": "str",
                                                                   "choices": ["disable", "enable"]},
                                            "ftgd_service": {"required": False, "type": "str",
                                                             "choices": ["disable", "enable"]}
                                        }},
