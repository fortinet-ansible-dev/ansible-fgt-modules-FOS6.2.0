...
options:
    ...
    firewall_internet_service:
        ...
        suboptions:
            ...
            jitter_threshold:
                description:
                    - Default jitter threshold of the Internet Service.
                type: int
            latency_threshold:
                description:
                    - Default latency threshold of the Internet Service.
                type: int
            name:
                description:
            ...
            packetloss_threshold:
                description:
                    - Default packetloss threshold of the Internet Service.
                type: int
            reputation:
                description:
...
def filter_firewall_internet_service_data(json):
    option_list = ['database', 'direction', 'extra_ip_range_number',
                   'icon_id', 'id', 'ip_number',
                   'ip_range_number', 'jitter_threshold', 'latency_threshold',
                   'name', 'obsolete', 'packetloss_threshold',
                   'reputation', 'singularity', 'sld_id']
    dictionary = {}
...
def firewall_internet_service(data, fos):
    ...
    if 'state' in data and data['state']:
        state = data['state']
    elif 'state' in data['firewall_internet_service'] and data['firewall_internet_service']['state']:
    ...
    fields = {
        ...
        "firewall_internet_service": {
            ...
            "options": {
                ...
                "extra_ip_range_number": {"required": False, "type": "int"},
