...
def firewall_internet_service_extension(data, fos):
    vdom = data['vdom']
    state = data['state']
    firewall_internet_service_extension_data = data['firewall_internet_service_extension']
    filtered_data = underscore_to_hyphen(filter_firewall_internet_service_extension_data(firewall_internet_service_extension_data))
...
def fortios_firewall(data, fos):
    ...
    if data['firewall_internet_service_extension']:
        resp = firewall_internet_service_extension(data, fos)
                ...
                "disable_entry": {"required": False, "type": "list",
                                  "options": {
                                      ...
                                      "port_range": {"required": False, "type": "list",
                                                     "options": {
                                                         "end_port": {"required": True, "type": "int"},
                                                         "id": {"required": True, "type": "int"},
                                                         "start_port": {"required": True, "type": "int"}
                                                     }},
                                      "protocol": {"required": True, "type": "int"}
                                  }},
