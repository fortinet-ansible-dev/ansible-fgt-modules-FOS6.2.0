...
def firewall_ssl_ssh_profile(data, fos):
    ...
    if 'state' in data and data['state']:
        state = data['state']
    elif 'state' in data['firewall_ssl_ssh_profile'] and data['firewall_ssl_ssh_profile']['state']:
    ...
    fields = {
        ...
        "firewall_ssl_ssh_profile": {
            ...
            "options": {
                "state": {"required": False, "type": "str",
                          "choices": ["present", "absent"]},
                "block_blacklisted_certificates": {"required": False, "type": "str",
                ...
                "ftps": {"required": False, "type": "dict",
                         "options": {
                             ...
                             "invalid_server_cert": {"required": False, "type": "str",
                                                     "choices": ["allow", "block"]},
                             "ports": {"required": True, "type": "int"},
                             "sni_server_cert_check": {"required": False, "type": "str",
                                                       "choices": ["enable", "strict", "disable"]},
                             "status": {"required": False, "type": "str",
                                        "choices": ["disable", "deep-inspection"]},
                             "unsupported_ssl": {"required": False, "type": "str",
                                                 "choices": ["bypass", "inspect", "block"]},
                             "untrusted_server_cert": {"required": False, "type": "str",
                ...
                "rpc_over_https": {"required": False, "type": "str",
                                   "choices": ["enable", "disable"]},
                "server_cert": {"required": True, "type": "str"},
                "server_cert_mode": {"required": True, "type": "str",
                ...
                "ssl_exemptions_log": {"required": False, "type": "str",
                                       "choices": ["disable", "enable"]},
                "ssl_server": {"required": True, "type": "list",
                               "options": {
                ...
                "untrusted_caname": {"required": True, "type": "str"},
