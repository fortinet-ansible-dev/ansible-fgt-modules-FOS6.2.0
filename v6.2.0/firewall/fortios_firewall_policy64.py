...
def filter_firewall_policy64_data(json):
    option_list = ['action', 'comments', 'dstaddr',
                   ...
                   'logtraffic', 'logtraffic_start', 'per_ip_shaper',
                   'permit_any_host', 'policyid', 'poolname',
                   'schedule', 'service', 'srcaddr',
                   'srcintf', 'status', 'tcp_mss_receiver',
                   'tcp_mss_sender', 'traffic_shaper', 'traffic_shaper_reverse',
                   'uuid']
    dictionary = {}
...
def firewall_policy64(data, fos):
    ...
    if 'state' in data and data['state']:
        state = data['state']
    elif 'state' in data['firewall_policy64'] and data['firewall_policy64']['state']:
    ...
    fields = {
        ...
        "firewall_policy64": {
            ...
            "options": {
                ...
                "dstintf": {"required": True, "type": "str"},
                ...
                "schedule": {"required": True, "type": "str"},
                ...
                "srcintf": {"required": True, "type": "str"},
