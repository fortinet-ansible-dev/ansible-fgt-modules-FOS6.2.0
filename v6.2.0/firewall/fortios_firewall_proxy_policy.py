...
def filter_firewall_proxy_policy_data(json):
    option_list = ['action', 'application_list', 'av_profile',
                   'cifs_profile', 'comments', 'disclaimer',
                   'dlp_sensor', 'dstaddr', 'dstaddr_negate',
                   'dstaddr6', 'dstintf', 'emailfilter_profile',
                   'global_label', 'groups', 'http_tunnel_auth',
                   ...
                   'logtraffic', 'logtraffic_start', 'policyid',
                   'poolname', 'profile_group', 'profile_protocol_options',
                   'profile_type', 'proxy', 'redirect_url',
                   'replacemsg_override_group', 'schedule', 'service',
