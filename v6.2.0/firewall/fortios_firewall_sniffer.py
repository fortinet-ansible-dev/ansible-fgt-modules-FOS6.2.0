...
def filter_firewall_sniffer_data(json):
    option_list = ['anomaly', 'application_list', 'application_list_status',
                   ...
                   'dlp_sensor_status', 'dsri', 'emailfilter_profile',
                   'emailfilter_profile_status', 'host', 'id',
                   'interface', 'ips_dos_status', 'ips_sensor',
                   'ips_sensor_status', 'ipv6', 'logtraffic',
                   'max_packet_count', 'non_ip', 'port',
                   'protocol', 'status', 'vlan',
...
def firewall_sniffer(data, fos):
    ...
    if 'state' in data and data['state']:
        state = data['state']
    elif 'state' in data['firewall_sniffer'] and data['firewall_sniffer']['state']:
