    ...
    fields = {
        ...
        "firewall_ippool": {
            ...
            "options": {
                ...
                "block_size": {"required": True, "type": "int"},
                "comments": {"required": False, "type": "str"},
                "endip": {"required": True, "type": "str"},
                "name": {"required": True, "type": "str"},
                "num_blocks_per_user": {"required": True, "type": "int"},
                "pba_timeout": {"required": False, "type": "int"},
                "permit_any_host": {"required": False, "type": "str",
                                    "choices": ["disable", "enable"]},
                "source_endip": {"required": True, "type": "str"},
                "source_startip": {"required": True, "type": "str"},
                "startip": {"required": True, "type": "str"},
