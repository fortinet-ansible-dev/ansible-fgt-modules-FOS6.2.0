...
def firewall_internet_service_addition(data, fos):
    vdom = data['vdom']
    state = data['state']
    firewall_internet_service_addition_data = data['firewall_internet_service_addition']
    filtered_data = underscore_to_hyphen(filter_firewall_internet_service_addition_data(firewall_internet_service_addition_data))
...
def fortios_firewall(data, fos):
    ...
    if data['firewall_internet_service_addition']:
        resp = firewall_internet_service_addition(data, fos)
