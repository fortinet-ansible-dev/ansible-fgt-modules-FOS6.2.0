...
def test_firewall_profile_protocol_options_creation(mocker):
    ...
    input_data = {
        'username': 'admin',
        'state': 'present',
        'firewall_profile_protocol_options': {'comment': 'Optional comments.',
                                              'name': 'default_name_4',
    ...
    expected_data = {'comment': 'Optional comments.',
                     'name': 'default_name_4',
...
def test_firewall_profile_protocol_options_filter_foreign_attributes(mocker):
    ...
    input_data = {
        ...
        'firewall_profile_protocol_options': {
            'random_attribute_not_valid': 'tag', 'comment': 'Optional comments.',
            'name': 'default_name_4',
            'oversize_log': 'disable',
            'replacemsg_group': 'test_value_6',
            'rpc_over_http': 'enable',
