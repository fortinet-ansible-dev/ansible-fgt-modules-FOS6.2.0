...
def firewall_vip6(data, fos):
    ...
    if 'state' in data and data['state']:
        state = data['state']
    elif 'state' in data['firewall_vip6'] and data['firewall_vip6']['state']:
    ...
    fields = {
        ...
        "firewall_vip6": {
            ...
            "options": {
                ...
                "extip": {"required": True, "type": "str"},
                "extport": {"required": True, "type": "str"},
                ...
                "ldb_method": {"required": False, "type": "str",
                               "choices": ["static", "round-robin", "weighted",
                                           ...
                                           "http-host"]},
                "mappedip": {"required": True, "type": "str"},
                ...
                "realservers": {"required": False, "type": "list",
                                "options": {
                                    ...
                                    "monitor": {"required": True, "type": "str"},
                                    "port": {"required": False, "type": "int"},
                                    "status": {"required": False, "type": "str",
                                               "choices": ["active", "standby", "disable"]},
                                    "weight": {"required": False, "type": "int"}
                                }},
                "server_type": {"required": True, "type": "str",
                ...
                "ssl_algorithm": {"required": False, "type": "str",
                                  "choices": ["high", "medium", "low",
                                              "custom"]},
                "ssl_certificate": {"required": True, "type": "str"},
                "ssl_cipher_suites": {"required": False, "type": "list",
                                      "options": {
                                          "cipher": {"required": True, "type": "str",
