...
def test_firewall_policy64_creation(mocker):
    ...
    input_data = {
        ...
        'firewall_policy64': {
            ...
            'per_ip_shaper': 'test_value_10',
            'permit_any_host': 'enable',
            'policyid': '12',
            'schedule': 'test_value_13',
            'srcintf': 'test_value_14',
            'status': 'enable',
            'tcp_mss_receiver': '16',
            'tcp_mss_sender': '17',
            'traffic_shaper': 'test_value_18',
            'traffic_shaper_reverse': 'test_value_19',
            'uuid': 'test_value_20'
        },
        'vdom': 'root'}
    ...
    expected_data = {
        ...
        'tcp-mss-receiver': '16',
        'tcp-mss-sender': '17',
        'traffic-shaper': 'test_value_18',
        'traffic-shaper-reverse': 'test_value_19',
        'uuid': 'test_value_20'
    }
