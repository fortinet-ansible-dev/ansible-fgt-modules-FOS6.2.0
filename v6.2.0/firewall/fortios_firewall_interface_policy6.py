...
def filter_firewall_interface_policy6_data(json):
    option_list = ['address_type', 'application_list', 'application_list_status',
                   ...
                   'dstaddr6', 'emailfilter_profile', 'emailfilter_profile_status',
                   'interface', 'ips_sensor', 'ips_sensor_status',
                   'label', 'logtraffic', 'policyid',
                   'service6', 'srcaddr6', 'status',
                   'webfilter_profile', 'webfilter_profile_status']
    dictionary = {}
...
def firewall_interface_policy6(data, fos):
    ...
    if 'state' in data and data['state']:
        state = data['state']
    elif 'state' in data['firewall_interface_policy6'] and data['firewall_interface_policy6']['state']:
    ...
    fields = {
        ...
        "firewall_interface_policy6": {
            ...
            "options": {
                ...
                "srcaddr6": {"required": True, "type": "list",
                             "options": {
                                 "name": {"required": True, "type": "str"}
                             }},
                "status": {"required": False, "type": "str",
                           "choices": ["enable", "disable"]},
                "webfilter_profile": {"required": True, "type": "str"},
