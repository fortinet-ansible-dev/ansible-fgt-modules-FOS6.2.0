...
def firewall_central_snat_map(data, fos):
    ...
    if 'state' in data and data['state']:
        state = data['state']
    elif 'state' in data['firewall_central_snat_map'] and data['firewall_central_snat_map']['state']:
    ...
    fields = {
        ...
        "firewall_central_snat_map": {
            ...
            "options": {
                ...
                "dst_addr": {"required": True, "type": "list",
                             "options": {
                ...
                "nat": {"required": True, "type": "str",
                        "choices": ["disable", "enable"]},
                "nat_ippool": {"required": False, "type": "list",
                               "options": {
                                   "name": {"required": True, "type": "str"}
                               }},
                "nat_port": {"required": True, "type": "str"},
                "orig_addr": {"required": True, "type": "list",
                              "options": {
                                  "name": {"required": True, "type": "str"}
                              }},
                "orig_port": {"required": True, "type": "str"},
                "policyid": {"required": True, "type": "int"},
                "protocol": {"required": True, "type": "int"},
                "srcintf": {"required": True, "type": "list",
                            "options": {
                                "name": {"required": True, "type": "str"}
                            }},
