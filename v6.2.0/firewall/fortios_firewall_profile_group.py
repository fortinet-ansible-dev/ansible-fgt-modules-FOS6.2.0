...
def filter_firewall_profile_group_data(json):
    option_list = ['application_list', 'av_profile', 'cifs_profile',
                   'dlp_sensor', 'dnsfilter_profile', 'emailfilter_profile',
                   'icap_profile', 'ips_sensor', 'name',
                   'profile_protocol_options', 'ssh_filter_profile', 'ssl_ssh_profile',
                   'voip_profile', 'waf_profile', 'webfilter_profile']
    dictionary = {}
