...
def test_firewall_shaping_policy_creation(mocker):
    ...
    input_data = {
        ...
        'firewall_shaping_policy': {'class_id': '3',
                                    ...
                                    'diffservcode_forward': 'test_value_7',
                                    'diffservcode_rev': 'test_value_8',
                                    'id': '9',
                                    'internet_service': 'enable',
                                    'internet_service_src': 'enable',
                                    'ip_version': '4',
                                    'name': 'default_name_13',
                                    'per_ip_shaper': 'test_value_14',
                                    'schedule': 'test_value_15',
                                    'status': 'enable',
                                    'tos': 'test_value_17',
                                    'tos_mask': 'test_value_18',
                                    'tos_negate': 'enable',
                                    'traffic_shaper': 'test_value_20',
                                    'traffic_shaper_reverse': 'test_value_21',
    ...
    expected_data = {'class-id': '3',
                     ...
                     'diffservcode-forward': 'test_value_7',
                     'diffservcode-rev': 'test_value_8',
                     'id': '9',
                     'internet-service': 'enable',
                     'internet-service-src': 'enable',
                     'ip-version': '4',
                     'name': 'default_name_13',
                     'per-ip-shaper': 'test_value_14',
                     'schedule': 'test_value_15',
                     'status': 'enable',
                     'tos': 'test_value_17',
                     'tos-mask': 'test_value_18',
                     'tos-negate': 'enable',
                     'traffic-shaper': 'test_value_20',
                     'traffic-shaper-reverse': 'test_value_21',
