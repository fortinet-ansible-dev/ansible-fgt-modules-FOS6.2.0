...
def filter_firewall_shaping_policy_data(json):
    option_list = ['app_category', 'app_group', 'application',
                   'class_id', 'comment', 'diffserv_forward',
                   'diffserv_reverse', 'diffservcode_forward', 'diffservcode_rev',
                   'dstaddr', 'dstaddr6', 'dstintf',
                   'groups', 'id', 'internet_service',
                   'internet_service_custom', 'internet_service_custom_group', 'internet_service_group',
                   'internet_service_id', 'internet_service_src', 'internet_service_src_custom',
                   'internet_service_src_custom_group', 'internet_service_src_group', 'internet_service_src_id',
                   'ip_version', 'name', 'per_ip_shaper',
                   'schedule', 'service', 'srcaddr',
                   'srcaddr6', 'srcintf', 'status',
    ...
    fields = {
        ...
        "firewall_shaping_policy": {
            ...
            "options": {
                ...
                "dstaddr": {"required": True, "type": "list",
                            "options": {
                                "name": {"required": True, "type": "str"}
                            }},
                ...
                "dstintf": {"required": True, "type": "list",
                            "options": {
                                "name": {"required": True, "type": "str"}
                            }},
                ...
                "service": {"required": True, "type": "list",
                            "options": {
                                "name": {"required": True, "type": "str"}
                            }},
                "srcaddr": {"required": True, "type": "list",
                            "options": {
                                "name": {"required": True, "type": "str"}
                            }},
