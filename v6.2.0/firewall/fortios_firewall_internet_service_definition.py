...
def firewall_internet_service_definition(data, fos):
    vdom = data['vdom']
    state = data['state']
    firewall_internet_service_definition_data = data['firewall_internet_service_definition']
    filtered_data = underscore_to_hyphen(filter_firewall_internet_service_definition_data(firewall_internet_service_definition_data))
...
def fortios_firewall(data, fos):
    ...
    if data['firewall_internet_service_definition']:
        resp = firewall_internet_service_definition(data, fos)
