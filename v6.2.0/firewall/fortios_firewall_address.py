...
def filter_firewall_address_data(json):
    option_list = ['allow_routing', 'associated_interface', 'cache_ttl',
                   ...
                   'end_ip', 'end_mac', 'epg_name',
                   'filter', 'fqdn', 'interface',
                   'list', 'name', 'obj_id',
                   'organization', 'policy_group', 'sdn',
                   'sdn_addr_type', 'sdn_tag', 'start_ip',
                   'start_mac', 'subnet', 'subnet_name',
                   'tagging', 'tenant', 'type',
    ...
    fields = {
        ...
        "firewall_address": {
            ...
            "options": {
                ...
                "end_mac": {"required": False, "type": "str"},
                ...
                "list": {"required": False, "type": "list",
                         "options": {
                             ...
                             "net_id": {"required": False, "type": "str"},
