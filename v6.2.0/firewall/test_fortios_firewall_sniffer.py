...
def test_firewall_sniffer_creation(mocker):
    ...
    input_data = {
        ...
        'firewall_sniffer': {'application_list': 'test_value_3',
                             ...
                             'non_ip': 'enable',
                             'port': 'test_value_22',
                             'protocol': 'test_value_23',
                             'status': 'enable',
                             'vlan': 'test_value_25',
                             'webfilter_profile': 'test_value_26',
    ...
    expected_data = {'application-list': 'test_value_3',
                     ...
                     'dsri': 'enable',
                     'emailfilter-profile': 'test_value_10',
                     'emailfilter-profile-status': 'enable',
                     'host': 'myhostname12',
                     'id': '13',
                     'interface': 'test_value_14',
                     'ips-dos-status': 'enable',
                     'ips-sensor': 'test_value_16',
                     ...
                     'status': 'enable',
                     'vlan': 'test_value_25',
                     'webfilter-profile': 'test_value_26',
