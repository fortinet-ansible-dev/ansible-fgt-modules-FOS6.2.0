...
def filter_vpn_ssl_web_portal_data(json):
    option_list = ['allow_user_access', 'auto_connect', 'bookmark_group',
                   ...
                   'skip_check_for_unsupported_os', 'smb_max_version', 'smb_min_version',
                   'smb_ntlmv1_auth', 'smbv1', 'split_dns',
                   'split_tunneling', 'split_tunneling_routing_address', 'theme',
                   'tunnel_mode', 'user_bookmark', 'user_group_bookmark',
                   'web_mode', 'windows_forticlient_download_url', 'wins_server1',
                   'wins_server2']
    dictionary = {}
        ...
        "vpn_ssl_web_portal": {
            ...
            "options": {
                ...
                "mac_addr_check": {"required": False, "type": "str",
                                   "choices": ["enable", "disable"]},
                "mac_addr_check_rule": {"required": True, "type": "list",
                                        "options": {
                                            "mac_addr_list": {"required": True, "type": "list",
                                                              "options": {
                ...
                "service_restriction": {"required": False, "type": "str",
                                        "choices": ["enable", "disable"]},
                "skip_check_for_browser": {"required": False, "type": "str",
                                           "choices": ["enable", "disable"]},
                "skip_check_for_unsupported_os": {"required": False, "type": "str",
                                                  "choices": ["enable", "disable"]},
                "smb_max_version": {"required": False, "type": "str",
                                    "choices": ["smbv1", "smbv2", "smbv3"]},
                "smb_min_version": {"required": False, "type": "str",
                                    "choices": ["smbv1", "smbv2", "smbv3"]},
