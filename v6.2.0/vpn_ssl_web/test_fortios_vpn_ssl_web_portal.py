...
def test_vpn_ssl_web_portal_creation(mocker):
    ...
    input_data = {
        ...
        'vpn_ssl_web_portal': {
            ...
            'web_mode': 'enable',
            'windows_forticlient_download_url': 'test_value_52',
            'wins_server1': 'test_value_53',
            'wins_server2': 'test_value_54'
        },
        'vdom': 'root'}
    ...
    expected_data = {
        ...
        'name': 'default_name_35',
                ...
                'smb-max-version': 'smbv1',
                'smb-min-version': 'smbv1',
                ...
                'web-mode': 'enable',
                'windows-forticlient-download-url': 'test_value_52',
                'wins-server1': 'test_value_53',
                'wins-server2': 'test_value_54'
    }
