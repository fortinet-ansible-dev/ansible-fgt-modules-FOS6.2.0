...
def log_fortianalyzer_cloud_override_setting(data, fos):
    vdom = data['vdom']
    log_fortianalyzer_cloud_override_setting_data = data['log_fortianalyzer_cloud_override_setting']
    filtered_data = underscore_to_hyphen(filter_log_fortianalyzer_cloud_override_setting_data(log_fortianalyzer_cloud_override_setting_data))
