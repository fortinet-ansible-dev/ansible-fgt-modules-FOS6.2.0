...
def filter_user_setting_data(json):
    option_list = ['auth_blackout_time', 'auth_ca_cert', 'auth_cert',
                   ...
                   'auth_ssl_allow_renegotiation', 'auth_timeout', 'auth_timeout_type',
                   'auth_type', 'per_policy_disclaimer', 'radius_ses_timeout_act']
    dictionary = {}
    ...
    fields = {
        ...
        "user_setting": {
            ...
            "options": {
                ...
                "auth_on_demand": {"required": False, "type": "str",
                                   "choices": ["always", "implicitly"]},
                ...
                "auth_type": {"required": False, "type": "str",
                              "choices": ["http", "https", "ftp",
                                          "telnet"]},
                "per_policy_disclaimer": {"required": False, "type": "str",
                                          "choices": ["enable", "disable"]},
