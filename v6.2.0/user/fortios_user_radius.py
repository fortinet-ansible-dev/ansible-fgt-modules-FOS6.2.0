...
def user_radius(data, fos):
    ...
    if 'state' in data and data['state']:
        state = data['state']
    elif 'state' in data['user_radius'] and data['user_radius']['state']:
    ...
    fields = {
        ...
        "user_radius": {
            ...
            "options": {
                ...
                "rsso": {"required": True, "type": "str",
                         "choices": ["enable", "disable"]},
                "rsso_context_timeout": {"required": True, "type": "int"},
                "rsso_endpoint_attribute": {"required": True, "type": "str",
                                            "choices": ["User-Name", "NAS-IP-Address", "Framed-IP-Address",
                                                        ...
                                                        "Acct-Multi-Session-Id"]},
                "rsso_endpoint_block_attribute": {"required": True, "type": "str",
                                                  "choices": ["User-Name", "NAS-IP-Address", "Framed-IP-Address",
                                                              "Framed-IP-Netmask", "Filter-Id", "Login-IP-Host",
                                                              "Reply-Message", "Callback-Number", "Callback-Id",
                                                              "Framed-Route", "Framed-IPX-Network", "Class",
                ...
                "rsso_log_flags": {"required": False, "type": "str",
                                   "choices": ["protocol-error", "profile-missing", "accounting-stop-missed",
                                               ...
                                               "none"]},
                "rsso_log_period": {"required": True, "type": "int"},
                "rsso_radius_response": {"required": True, "type": "str",
                                         "choices": ["enable", "disable"]},
                "rsso_radius_server_port": {"required": True, "type": "int"},
                "rsso_secret": {"required": True, "type": "str"},
                "rsso_validate_request_secret": {"required": True, "type": "str",
                                                 "choices": ["enable", "disable"]},
                ...
                "server": {"required": True, "type": "str"},
                "source_ip": {"required": False, "type": "str"},
                "sso_attribute": {"required": True, "type": "str",
                                  "choices": ["User-Name", "NAS-IP-Address", "Framed-IP-Address",
                                              "Framed-IP-Netmask", "Filter-Id", "Login-IP-Host",
                                              "Reply-Message", "Callback-Number", "Callback-Id",
                                              "Framed-Route", "Framed-IPX-Network", "Class",
                ...
                "sso_attribute_value_override": {"required": True, "type": "str",
                                                 "choices": ["enable", "disable"]},
