...
def filter_user_ldap_data(json):
    option_list = ['account_key_filter', 'account_key_processing', 'ca_cert',
                   ...
                   'member_attr', 'name', 'obtain_user_info',
                   'password', 'password_expiry_warning', 'password_renewal',
                   'port', 'search_type', 'secondary_server',
                   'secure', 'server', 'server_identity_check',
                   'source_ip', 'ssl_min_proto_version', 'tertiary_server',
                   'type', 'user_info_exchange_server', 'username']
    dictionary = {}
    ...
    fields = {
        ...
        "user_ldap": {
            ...
            "options": {
                ...
                "obtain_user_info": {"required": False, "type": "str",
                ...
                "search_type": {"required": False, "type": "str",
                                "choices": ["recursive"]},
                ...
                "user_info_exchange_server": {"required": False, "type": "str"},
