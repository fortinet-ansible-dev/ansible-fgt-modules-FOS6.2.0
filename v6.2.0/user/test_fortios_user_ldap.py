...
def test_user_ldap_creation(mocker):
    ...
    input_data = {
        ...
        'user_ldap': {
            ...
            'secondary_server': 'test_value_20',
            'secure': 'disable',
            'server': '192.168.100.22',
            'server_identity_check': 'enable',
            'source_ip': '84.230.14.24',
            'ssl_min_proto_version': 'default',
            'tertiary_server': 'test_value_26',
            'type': 'simple',
            'user_info_exchange_server': 'test_value_28',
            'username': 'test_value_29'
        },
        'vdom': 'root'}
    ...
    expected_data = {
        ...
        'cnid': 'test_value_6',
                ...
                'secondary-server': 'test_value_20',
                'secure': 'disable',
                'server': '192.168.100.22',
                'server-identity-check': 'enable',
                'source-ip': '84.230.14.24',
                'ssl-min-proto-version': 'default',
                'tertiary-server': 'test_value_26',
                'type': 'simple',
                'user-info-exchange-server': 'test_value_28',
                'username': 'test_value_29'
    }
