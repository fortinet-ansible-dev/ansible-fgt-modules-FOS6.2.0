...
def webfilter_override(data, fos):
    ...
    if 'state' in data and data['state']:
        state = data['state']
    elif 'state' in data['webfilter_override'] and data['webfilter_override']['state']:
    ...
    fields = {
        ...
        "webfilter_override": {
            ...
            "options": {
                "state": {"required": False, "type": "str",
                          "choices": ["present", "absent"]},
                "expires": {"required": True, "type": "str"},
                "id": {"required": True, "type": "int"},
                "initiator": {"required": False, "type": "str"},
                "ip": {"required": True, "type": "str"},
                "ip6": {"required": True, "type": "str"},
                "new_profile": {"required": True, "type": "str"},
                "old_profile": {"required": True, "type": "str"},
                ...
                "user_group": {"required": True, "type": "str"}
