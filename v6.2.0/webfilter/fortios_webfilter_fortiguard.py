...
def filter_webfilter_fortiguard_data(json):
    option_list = ['cache_mem_percent', 'cache_mode', 'cache_prefix_match',
                   ...
                   'ovrd_auth_port_http', 'ovrd_auth_port_https', 'ovrd_auth_port_https_flow',
                   'ovrd_auth_port_warning', 'request_packet_size_limit', 'warn_auth_https']
    dictionary = {}
    ...
    fields = {
        ...
        "webfilter_fortiguard": {
            ...
            "options": {
                ...
                "ovrd_auth_port_https_flow": {"required": False, "type": "int"},
