...
def test_icap_profile_creation(mocker):
    ...
    input_data = {
        'username': 'admin',
        'state': 'present',
        'icap_profile': {'methods': 'delete',
                         'name': 'default_name_4',
                         'preview': 'disable',
                         'preview_data_length': '6',
                         'replacemsg_group': 'test_value_7',
                         'request': 'disable',
                         'request_failure': 'error',
                         'request_path': 'test_value_10',
                         'request_server': 'test_value_11',
                         'response': 'disable',
                         'response_failure': 'error',
                         'response_path': 'test_value_14',
                         'response_req_hdr': 'disable',
                         'response_server': 'test_value_16',
    ...
    expected_data = {'methods': 'delete',
                     ...
                     'request-path': 'test_value_10',
                     'request-server': 'test_value_11',
                     'response': 'disable',
                     'response-failure': 'error',
                     'response-path': 'test_value_14',
                     'response-req-hdr': 'disable',
                     'response-server': 'test_value_16',
...
def test_icap_profile_filter_foreign_attributes(mocker):
    ...
    input_data = {
        ...
        'state': 'present',
        'icap_profile': {
            'random_attribute_not_valid': 'tag', 'methods': 'delete',
            'name': 'default_name_4',
            'preview': 'disable',
            'preview_data_length': '6',
            'replacemsg_group': 'test_value_7',
