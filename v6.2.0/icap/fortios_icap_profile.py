...
def filter_icap_profile_data(json):
    option_list = ['icap_headers', 'methods', 'name',
                   ...
                   'response_path', 'response_req_hdr', 'response_server',
                   'streaming_content_bypass']
    dictionary = {}
...
def icap_profile(data, fos):
    ...
    if 'state' in data and data['state']:
        state = data['state']
    elif 'state' in data['icap_profile'] and data['icap_profile']['state']:
    ...
    fields = {
        ...
        "icap_profile": {
            ...
            "options": {
                "state": {"required": False, "type": "str",
                          "choices": ["present", "absent"]},
                "icap_headers": {"required": False, "type": "list",
                                 "options": {
                                     "base64_encoding": {"required": False, "type": "str",
                ...
                "preview": {"required": False, "type": "str",
                            "choices": ["disable", "enable"]},
                "preview_data_length": {"required": False, "type": "int"},
                ...
                "request_server": {"required": True, "type": "str"},
                "response": {"required": False, "type": "str",
                             "choices": ["disable", "enable"]},
                "response_failure": {"required": False, "type": "str",
                                     "choices": ["error", "bypass"]},
                "response_path": {"required": False, "type": "str"},
                "response_req_hdr": {"required": False, "type": "str",
                                     "choices": ["disable", "enable"]},
                "response_server": {"required": True, "type": "str"},
