...
def filter_router_setting_data(json):
    option_list = ['bgp_debug_flags', 'hostname', 'igmp_debug_flags',
                   'imi_debug_flags', 'isis_debug_flags', 'ospf6_debug_events_flags',
                   'ospf6_debug_ifsm_flags', 'ospf6_debug_lsa_flags', 'ospf6_debug_nfsm_flags',
                   'ospf6_debug_nsm_flags', 'ospf6_debug_packet_flags', 'ospf6_debug_route_flags',
                   'ospf_debug_events_flags', 'ospf_debug_ifsm_flags', 'ospf_debug_lsa_flags',
                   'ospf_debug_nfsm_flags', 'ospf_debug_nsm_flags', 'ospf_debug_packet_flags',
                   'ospf_debug_route_flags', 'pimdm_debug_flags', 'pimsm_debug_joinprune_flags',
                   'pimsm_debug_simple_flags', 'pimsm_debug_timer_flags', 'rip_debug_flags',
                   'ripng_debug_flags', 'show_filter']
    dictionary = {}
