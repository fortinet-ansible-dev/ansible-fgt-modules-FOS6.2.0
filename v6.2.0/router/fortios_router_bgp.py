...
def filter_router_bgp_data(json):
    option_list = ['additional_path', 'additional_path_select', 'additional_path_select6',
                   'additional_path6', 'admin_distance', 'aggregate_address',
                   'aggregate_address6', 'always_compare_med', 'as',
                   'bestpath_as_path_ignore', 'bestpath_cmp_confed_aspath', 'bestpath_cmp_routerid',
                   ...
                   'dampening_reuse', 'dampening_route_map', 'dampening_suppress',
                   'dampening_unreachability_half_life', 'default_local_preference', 'deterministic_med',
                   'distance_external', 'distance_internal', 'distance_local',
                   'ebgp_multipath', 'enforce_first_as', 'fast_external_failover',
                   'graceful_end_on_timer', 'graceful_restart', 'graceful_restart_time',
                   'graceful_stalepath_time', 'graceful_update_delay', 'holdtime_timer',
                   'ibgp_multipath', 'ignore_optional_capability', 'keepalive_timer',
                   'log_neighbour_changes', 'neighbor', 'neighbor_group',
                   'neighbor_range', 'neighbor_range6', 'network',
                   'network_import_check', 'network6', 'redistribute',
                   'redistribute6', 'router_id', 'scan_time',
                   'synchronization']
    dictionary = {}
...
def main():
    fields = {
        ...
        "router_bgp": {
            ...
            "options": {
                "additional_path": {"required": False, "type": "str",
                                    "choices": ["enable", "disable"]},
                "additional_path_select": {"required": False, "type": "int"},
                "additional_path_select6": {"required": False, "type": "int"},
                "additional_path6": {"required": False, "type": "str",
                                     "choices": ["enable", "disable"]},
                "admin_distance": {"required": False, "type": "list",
                                   "options": {
                                       "distance": {"required": True, "type": "int"},
                                       "id": {"required": True, "type": "int"},
                                       "neighbour_prefix": {"required": True, "type": "str"},
                ...
                "aggregate_address6": {"required": False, "type": "list",
                                       "options": {
                                           "as_set": {"required": False, "type": "str",
                                                      "choices": ["enable", "disable"]},
                                           "id": {"required": True, "type": "int"},
                                           "prefix6": {"required": True, "type": "str"},
                                           "summary_only": {"required": False, "type": "str",
                                                            "choices": ["enable", "disable"]}
                                       }},
                ...
                "neighbor": {"required": False, "type": "list",
                             "options": {
                                 ...
                                 "additional_path6": {"required": False, "type": "str",
                                                      "choices": ["send", "receive", "both",
                                                                  "disable"]},
                                 "adv_additional_path": {"required": False, "type": "int"},
                                 "adv_additional_path6": {"required": False, "type": "int"},
                                 ...
                                 "conditional_advertise": {"required": False, "type": "list",
                                                           "options": {
                                                               "advertise_routemap": {"required": True, "type": "str"},
                                                               "condition_routemap": {"required": True, "type": "str"},
                ...
                "neighbor_range": {"required": False, "type": "list",
                                   "options": {
                                       ...
                                       "neighbor_group": {"required": True, "type": "str"},
                                       "prefix": {"required": True, "type": "str"}
                                   }},
