...
def filter_authentication_setting_data(json):
    option_list = ['active_auth_scheme', 'auth_https', 'captive_portal',
                   'captive_portal_ip', 'captive_portal_ip6', 'captive_portal_port',
                   'captive_portal_ssl_port', 'captive_portal_type', 'captive_portal6',
                   'sso_auth_scheme']
    dictionary = {}
    ...
    fields = {
        ...
        "authentication_setting": {
            ...
            "options": {
                ...
                "auth_https": {"required": False, "type": "str",
                ...
                "captive_portal_ssl_port": {"required": False, "type": "int"},
