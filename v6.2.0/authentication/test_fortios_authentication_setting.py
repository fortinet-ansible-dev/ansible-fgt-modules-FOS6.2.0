...
def test_authentication_setting_creation(mocker):
    ...
    input_data = {
        ...
        'authentication_setting': {
            ...
            'auth_https': 'enable',
            'captive_portal': 'test_value_5',
            'captive_portal_ip': 'test_value_6',
            'captive_portal_ip6': 'test_value_7',
            'captive_portal_port': '8',
            'captive_portal_ssl_port': '9',
            'captive_portal_type': 'fqdn',
            'captive_portal6': 'test_value_11',
            'sso_auth_scheme': 'test_value_12'
        },
        'vdom': 'root'}
    ...
    expected_data = {
        ...
        'auth-https': 'enable',
        'captive-portal': 'test_value_5',
        'captive-portal-ip': 'test_value_6',
        'captive-portal-ip6': 'test_value_7',
        'captive-portal-port': '8',
        'captive-portal-ssl-port': '9',
        'captive-portal-type': 'fqdn',
        'captive-portal6': 'test_value_11',
        'sso-auth-scheme': 'test_value_12'
    }
