...
def filter_cifs_domain_controller_data(json):
    option_list = ['domain_name', 'ip', 'ip6',
                   'password', 'port', 'server_name',
                   'username']
    dictionary = {}
...
def cifs_domain_controller(data, fos):
    vdom = data['vdom']
    state = data['state']
    cifs_domain_controller_data = data['cifs_domain_controller']
    filtered_data = underscore_to_hyphen(filter_cifs_domain_controller_data(cifs_domain_controller_data))
...
def fortios_cifs(data, fos):
    ...
    if data['cifs_domain_controller']:
        resp = cifs_domain_controller(data, fos)
