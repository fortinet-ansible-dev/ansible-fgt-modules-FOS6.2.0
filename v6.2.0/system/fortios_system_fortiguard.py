...
def filter_system_fortiguard_data(json):
    option_list = ['antispam_cache', 'antispam_cache_mpercent', 'antispam_cache_ttl',
                   ...
                   'port', 'protocol', 'sandbox_region',
                   'sdns_server_ip', 'sdns_server_port', 'service_account_id',
    ...
    fields = {
        ...
        "system_fortiguard": {
            ...
            "options": {
                ...
                "antispam_timeout": {"required": True, "type": "int"},
                ...
                "outbreak_prevention_timeout": {"required": True, "type": "int"},
                ...
                "webfilter_timeout": {"required": True, "type": "int"}
