...
def filter_system_automation_trigger_data(json):
    option_list = ['event_type', 'faz_event_name', 'faz_event_severity',
                   ...
                   'trigger_day', 'trigger_frequency', 'trigger_hour',
                   'trigger_minute', 'trigger_type', 'trigger_weekday']
    dictionary = {}
            ...
            "options": {
                "event_type": {"required": False, "type": "str",
                               "choices": ["ioc", "event-log", "reboot",
                                           ...
                                           "virus-ips-db-updated", "faz-event"]},
                "faz_event_name": {"required": True, "type": "str"},
