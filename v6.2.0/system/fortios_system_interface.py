...
def filter_system_interface_data(json):
    option_list = ['ac_name', 'aggregate', 'algorithm',
                   ...
                   'dhcp_relay_agent_option', 'dhcp_relay_ip', 'dhcp_relay_service',
                   'dhcp_relay_type', 'dhcp_renew_time', 'disc_retry_timeout',
                   'disconnect_threshold', 'distance', 'dns_server_override',
                   'drop_fragment', 'drop_overlapped_fragment', 'egress_shaping_profile',
                   ...
                   'fortilink_backup_link', 'fortilink_split_interface', 'fortilink_stacking',
                   'forward_domain', 'gwdetect', 'ha_priority',
                   'icmp_accept_redirect', 'icmp_send_redirect', 'ident_accept',
                   'idle_timeout', 'inbandwidth', 'ingress_spillover_threshold',
                   ...
                   'management_ip', 'member', 'min_links',
                   'min_links_down', 'mode', 'mtu',
                   'mtu_override', 'name', 'ndiscforward',
                   'netbios_forward', 'netflow_sampler', 'outbandwidth',
                   'padt_retry_timeout', 'password', 'ping_serv_status',
                   'polling_interval', 'pppoe_unnumbered_negotiate', 'pptp_auth_type',
                   'pptp_client', 'pptp_password', 'pptp_server_ip',
                   'pptp_timeout', 'pptp_user', 'preserve_session_route',
                   'priority', 'priority_override', 'proxy_captive_portal',
                   'redundant_interface', 'remote_ip', 'replacemsg_override_group',
                   ...
                   'subst', 'substitute_dst_mac', 'switch',
                   'switch_controller_access_vlan', 'switch_controller_arp_inspection', 'switch_controller_dhcp_snooping',
                   'switch_controller_dhcp_snooping_option82', 'switch_controller_dhcp_snooping_verify_mac', 'switch_controller_igmp_snooping',
                   'switch_controller_learning_limit', 'switch_controller_traffic_policy', 'tagging',
                   'tcp_mss', 'trust_ip_1', 'trust_ip_2',
                   'trust_ip_3', 'trust_ip6_1', 'trust_ip6_2',
                   'trust_ip6_3', 'type', 'username',
                   'vdom', 'vindex', 'vlanforward',
                   'vlanid', 'vrf', 'vrrp',
                   'vrrp_virtual_mac', 'wccp', 'weight',
                   'wins_ip']
    dictionary = {}
            ...
            "options": {
                ...
                "ipv6": {"required": False, "type": "dict",
                         "options": {
                             ...
                             "ip6_delegated_prefix_list": {"required": False, "type": "list",
                                                           "options": {
                                                               ...
                                                               "onlink_flag": {"required": False, "type": "str",
                                                                               "choices": ["enable", "disable"]},
                                                               "prefix_id": {"required": True, "type": "int"},
                                                               ...
                                                               "upstream_interface": {"required": True, "type": "str"}
                                                           }},
                             ...
                             "ip6_upstream_interface": {"required": True, "type": "str"},
                             "nd_cert": {"required": True, "type": "str"},
                ...
                "member": {"required": True, "type": "list",
                           "options": {
                               "interface_name": {"required": True, "type": "str"}
                           }},
                ...
                "security_mac_auth_bypass": {"required": False, "type": "str",
                                             "choices": ["mac-auth-only", "enable", "disable"]},
