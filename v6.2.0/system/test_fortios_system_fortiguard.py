...
def test_system_fortiguard_creation(mocker):
    ...
    input_data = {
        ...
        'system_fortiguard': {
            ...
            'port': '8888',
            'protocol': 'udp',
            'sandbox_region': 'test_value_23',
            'sdns_server_ip': 'test_value_24',
            'sdns_server_port': '25',
            'service_account_id': 'test_value_26',
            'source_ip': '84.230.14.27',
            'source_ip6': 'test_value_28',
    ...
    expected_data = {
        ...
        'port': '8888',
                'protocol': 'udp',
                'sandbox-region': 'test_value_23',
                'sdns-server-ip': 'test_value_24',
                'sdns-server-port': '25',
                'service-account-id': 'test_value_26',
                'source-ip': '84.230.14.27',
                'source-ip6': 'test_value_28',
                'update-server-location': 'usa',
                'webfilter-cache': 'enable',
                'webfilter-cache-ttl': '31',
                'webfilter-expiration': '32',
                'webfilter-force-off': 'enable',
                'webfilter-license': '34',
                'webfilter-timeout': '35'
    }
