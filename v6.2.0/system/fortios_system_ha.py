...
def filter_system_ha_data(json):
    option_list = ['arps', 'arps_interval', 'authentication',
                   ...
                   'link_failed_signal', 'load_balance_all', 'logical_sn',
                   'memory_compatible_mode', 'memory_threshold', 'mode',
                   'monitor', 'multicast_ttl', 'nntp_proxy_threshold',
                   'override', 'override_wait_time', 'password',
                   'pingserver_failover_threshold', 'pingserver_flip_timeout', 'pingserver_monitor_interface',
                   'pingserver_slave_force_reset', 'pop3_proxy_threshold', 'priority',
                   'route_hold', 'route_ttl', 'route_wait',
                   'schedule', 'secondary_vcluster', 'session_pickup',
                   'session_pickup_connectionless', 'session_pickup_delay', 'session_pickup_expectation',
                   'session_pickup_nat', 'session_sync_dev', 'smtp_proxy_threshold',
                   'ssd_failover', 'standalone_config_sync', 'standalone_mgmt_vdom',
                   'sync_config', 'sync_packet_balance', 'unicast_hb',
                   'unicast_hb_netmask', 'unicast_hb_peerip', 'uninterruptible_upgrade',
        ...
        "system_ha": {
            ...
            "options": {
                ...
                "load_balance_all": {"required": False, "type": "str",
                                     "choices": ["enable", "disable"]},
                "logical_sn": {"required": False, "type": "str",
                               "choices": ["enable", "disable"]},
                ...
                "ssd_failover": {"required": False, "type": "str",
                                 "choices": ["enable", "disable"]},
