...
def test_system_interface_creation(mocker):
    ...
    input_data = {
        ...
        'system_interface': {
            ...
            'devindex': '30',
            'dhcp_client_identifier': 'myId_31',
            'dhcp_relay_agent_option': 'enable',
            'dhcp_relay_ip': 'test_value_33',
            'dhcp_relay_service': 'disable',
            'dhcp_relay_type': 'regular',
            'dhcp_renew_time': '36',
            'disc_retry_timeout': '37',
            'disconnect_threshold': '38',
            'distance': '39',
            'dns_server_override': 'enable',
            'drop_fragment': 'enable',
            'drop_overlapped_fragment': 'enable',
            'egress_shaping_profile': 'test_value_43',
            'estimated_downstream_bandwidth': '44',
            'estimated_upstream_bandwidth': '45',
            ...
            'idle_timeout': '64',
            'inbandwidth': '65',
            'ingress_spillover_threshold': '66',
            'interface': 'test_value_67',
            'internal': '68',
            'ip': 'test_value_69',
            'ipmac': 'enable',
            'ips_sniffer_mode': 'enable',
            'ipunnumbered': 'test_value_72',
            'l2forward': 'enable',
            'lacp_ha_slave': 'enable',
            'lacp_mode': 'static',
            'lacp_speed': 'slow',
            'lcp_echo_interval': '77',
            'lcp_max_echo_fails': '78',
            'link_up_delay': '79',
            'lldp_network_policy': 'test_value_80',
            ...
            'sample_rate': '115',
            'secondary_IP': 'enable',
            'security_exempt_list': 'test_value_117',
            'security_external_logout': 'test_value_118',
            'security_external_web': 'test_value_119',
            'security_mac_auth_bypass': 'mac-auth-only',
            'security_mode': 'none',
            'security_redirect_url': 'test_value_122',
            'service_name': 'test_value_123',
            'sflow_sampler': 'enable',
            'snmp_index': '125',
            'speed': 'auto',
            'spillover_threshold': '127',
            'src_check': 'enable',
            'status': 'up',
            'stpforward': 'enable',
            'stpforward_mode': 'rpl-all-ext-id',
            'subst': 'enable',
            'substitute_dst_mac': 'test_value_133',
            'switch': 'test_value_134',
            ...
            'switch_controller_learning_limit': '141',
            'switch_controller_traffic_policy': 'test_value_142',
            'tcp_mss': '143',
    ...
    expected_data = {
        ...
        'devindex': '30',
        'dhcp-client-identifier': 'myId_31',
        'dhcp-relay-agent-option': 'enable',
        'dhcp-relay-ip': 'test_value_33',
        'dhcp-relay-service': 'disable',
        'dhcp-relay-type': 'regular',
        'dhcp-renew-time': '36',
        'disc-retry-timeout': '37',
        'disconnect-threshold': '38',
        'distance': '39',
        'dns-server-override': 'enable',
        'drop-fragment': 'enable',
        'drop-overlapped-fragment': 'enable',
        'egress-shaping-profile': 'test_value_43',
        'estimated-downstream-bandwidth': '44',
        'estimated-upstream-bandwidth': '45',
        ...
        'idle-timeout': '64',
        'inbandwidth': '65',
        'ingress-spillover-threshold': '66',
        'interface': 'test_value_67',
        'internal': '68',
        'ip': 'test_value_69',
        'ipmac': 'enable',
        ...
        'lacp-mode': 'static',
        'lacp-speed': 'slow',
        'lcp-echo-interval': '77',
        'lcp-max-echo-fails': '78',
        'link-up-delay': '79',
        'lldp-network-policy': 'test_value_80',
        ...
        'mode': 'static',
                ...
                'sample-rate': '115',
                'secondary-IP': 'enable',
                'security-exempt-list': 'test_value_117',
                'security-external-logout': 'test_value_118',
                'security-external-web': 'test_value_119',
                'security-mac-auth-bypass': 'mac-auth-only',
                'security-mode': 'none',
                'security-redirect-url': 'test_value_122',
                'service-name': 'test_value_123',
                'sflow-sampler': 'enable',
                'snmp-index': '125',
                'speed': 'auto',
                'spillover-threshold': '127',
                'src-check': 'enable',
                'status': 'up',
                'stpforward': 'enable',
                'stpforward-mode': 'rpl-all-ext-id',
                'subst': 'enable',
                'substitute-dst-mac': 'test_value_133',
                'switch': 'test_value_134',
                ...
                'switch-controller-learning-limit': '141',
                'switch-controller-traffic-policy': 'test_value_142',
                'tcp-mss': '143',
