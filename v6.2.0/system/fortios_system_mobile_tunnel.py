    ...
    fields = {
        ...
        "system_mobile_tunnel": {
            ...
            "options": {
                ...
                "home_agent": {"required": True, "type": "str"},
                "lifetime": {"required": True, "type": "int"},
                "n_mhae_key": {"required": False, "type": "str"},
                "n_mhae_key_type": {"required": True, "type": "str",
                                    "choices": ["ascii", "base64"]},
                "n_mhae_spi": {"required": True, "type": "int"},
                ...
                "reg_interval": {"required": True, "type": "int"},
                "reg_retry": {"required": True, "type": "int"},
                "renew_interval": {"required": True, "type": "int"},
                "roaming_interface": {"required": True, "type": "str"},
                "status": {"required": False, "type": "str",
                           "choices": ["disable", "enable"]},
                "tunnel_mode": {"required": True, "type": "str",
                                "choices": ["gre"]}
