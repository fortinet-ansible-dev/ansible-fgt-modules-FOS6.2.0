...
def test_system_vdom_dns_creation(mocker):
    ...
    input_data = {
        ...
        'system_vdom_dns': {
            ...
            'ip6_primary': 'test_value_4',
            'ip6_secondary': 'test_value_5',
            'primary': 'test_value_6',
            'secondary': 'test_value_7',
            'source_ip': '84.230.14.8',
            'ssl_certificate': 'test_value_9',
            'vdom_dns': 'enable'
        },
        'vdom': 'root'}
    ...
    expected_data = {
        ...
        'ip6-primary': 'test_value_4',
        'ip6-secondary': 'test_value_5',
        'primary': 'test_value_6',
        'secondary': 'test_value_7',
        'source-ip': '84.230.14.8',
        'ssl-certificate': 'test_value_9',
        'vdom-dns': 'enable'
    }
