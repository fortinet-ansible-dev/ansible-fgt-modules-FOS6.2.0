...
def test_system_dns_creation(mocker):
    ...
    input_data = {
        ...
        'system_dns': {
            ...
            'ip6_primary': 'test_value_7',
            'ip6_secondary': 'test_value_8',
            'primary': 'test_value_9',
            'retry': '10',
            'secondary': 'test_value_11',
            'source_ip': '84.230.14.12',
            'ssl_certificate': 'test_value_13',
            'timeout': '14'
        },
        'vdom': 'root'}
    ...
    expected_data = {
        ...
        'ip6-primary': 'test_value_7',
        'ip6-secondary': 'test_value_8',
        'primary': 'test_value_9',
        'retry': '10',
        'secondary': 'test_value_11',
        'source-ip': '84.230.14.12',
        'ssl-certificate': 'test_value_13',
        'timeout': '14'
    }
