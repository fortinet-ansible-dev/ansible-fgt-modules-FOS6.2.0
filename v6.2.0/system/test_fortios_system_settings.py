...
def test_system_settings_creation(mocker):
    ...
    input_data = {
        ...
        'system_settings': {
            ...
            'device': 'test_value_21',
            'dhcp_proxy': 'enable',
            'dhcp_server_ip': 'test_value_23',
            'dhcp6_server_ip': 'test_value_24',
            'discovered_device_timeout': '25',
            'ecmp_max_paths': '26',
            'email_portal_check_dns': 'disable',
            'firewall_session_dirty': 'check-all',
            'fw_session_hairpin': 'enable',
            'gateway': 'test_value_30',
            'gateway6': 'test_value_31',
            ...
            'ssl_ssh_profile': 'test_value_106',
            'status': 'enable',
    ...
    expected_data = {
        ...
        'device': 'test_value_21',
        'dhcp-proxy': 'enable',
        'dhcp-server-ip': 'test_value_23',
        'dhcp6-server-ip': 'test_value_24',
        'discovered-device-timeout': '25',
        'ecmp-max-paths': '26',
        ...
        'sccp-port': '97',
        'sctp-session-without-init': 'enable',
        ...
        'ssl-ssh-profile': 'test_value_106',
        'status': 'enable',
