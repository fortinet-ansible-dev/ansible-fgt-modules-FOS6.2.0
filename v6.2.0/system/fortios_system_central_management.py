...
def filter_system_central_management_data(json):
    option_list = ['allow_monitor', 'allow_push_configuration', 'allow_push_firmware',
                   ...
                   'local_cert', 'mode', 'schedule_config_restore',
                   'schedule_script_restore', 'serial_number', 'server_list',
                   'type', 'vdom']
    dictionary = {}
        ...
        "system_central_management": {
            ...
            "options": {
                ...
                "include_default_servers": {"required": False, "type": "str",
                                            "choices": ["enable", "disable"]},
                "local_cert": {"required": False, "type": "str"},
                ...
                "server_list": {"required": False, "type": "list",
                                "options": {
                                    ...
                                    "fqdn": {"required": True, "type": "str"},
                                    "id": {"required": True, "type": "int"},
                                    "server_address": {"required": True, "type": "str"},
                                    "server_address6": {"required": True, "type": "str"},
