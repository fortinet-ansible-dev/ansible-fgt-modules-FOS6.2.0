...
def filter_system_settings_data(json):
    option_list = ['allow_linkdown_path', 'allow_subnet_overlap', 'asymroute',
                   ...
                   'consolidated_firewall_mode', 'default_voip_alg_mode', 'deny_tcp_with_icmp',
                   'device', 'dhcp_proxy', 'dhcp_server_ip',
                   'dhcp6_server_ip', 'discovered_device_timeout', 'ecmp_max_paths',
                   'email_portal_check_dns', 'firewall_session_dirty', 'fw_session_hairpin',
                   'gateway', 'gateway6', 'gui_advanced_policy',
                   ...
                   'gui_endpoint_control_advanced', 'gui_explicit_proxy', 'gui_fortiap_split_tunneling',
                   'gui_fortiextender_controller', 'gui_icap', 'gui_implicit_policy',
                   'gui_ips', 'gui_load_balance', 'gui_local_in_policy',
                   'gui_local_reports', 'gui_multicast_policy', 'gui_multiple_interface_policy',
                   'gui_multiple_utm_profiles', 'gui_nat46_64', 'gui_object_colors',
                   'gui_policy_based_ipsec', 'gui_replacement_message_groups', 'gui_spamfilter',
                   ...
                   'lldp_reception', 'lldp_transmission', 'mac_ttl',
                   ...
                   'sctp_session_without_init', 'ses_denied_traffic', 'sip_helper',
        ...
        "system_settings": {
            ...
            "options": {
                ...
                "compliance_check": {"required": False, "type": "str",
                                     "choices": ["enable", "disable"]},
                "consolidated_firewall_mode": {"required": False, "type": "str",
                                               "choices": ["enable", "disable"]},
                ...
                "manageip": {"required": True, "type": "str"},
