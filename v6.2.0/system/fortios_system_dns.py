...
def filter_system_dns_data(json):
    option_list = ['cache_notfound_responses', 'dns_cache_limit', 'dns_cache_ttl',
                   'dns_over_tls', 'domain', 'ip6_primary',
                   'ip6_secondary', 'primary', 'retry',
                   'secondary', 'source_ip', 'ssl_certificate',
                   'timeout']
    dictionary = {}
    ...
    fields = {
        ...
        "system_dns": {
            ...
            "options": {
                ...
                "dns_over_tls": {"required": False, "type": "str",
                ...
                "primary": {"required": True, "type": "str"},
