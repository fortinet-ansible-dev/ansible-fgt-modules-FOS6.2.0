    ...
    system_global:
        ...
        suboptions:
            ...
            admin_hsts_max_age:
                ...
                type: int
            admin_http_connection_receive_timeout:
                description:
                    - Receive timeout for HTTP(s) connectivity to the FortiGate administrative GUI (1 - 60 seconds).
                type: int
...
def filter_system_global_data(json):
    option_list = ['admin_concurrent', 'admin_console_timeout', 'admin_hsts_max_age',
                   'admin_http_connection_receive_timeout', 'admin_https_pki_required', 'admin_https_redirect',
                   ...
                   'admin_ssh_port', 'admin_ssh_v1', 'admin_telnet',
                   ...
                   'autorun_log_fsck', 'av_affinity', 'av_failopen',
                   ...
                   'cli_audit_log', 'cloud_communication', 'clt_cert_req',
                   ...
                   'fortitoken_cloud_service', 'gui_certificates', 'gui_custom_language',
                   'gui_date_format', 'gui_date_time_source', 'gui_device_latitude',
                   ...
                   'max_dlpstat_memory', 'max_route_cache_size', 'memory_use_threshold_extreme',
                   'memory_use_threshold_green', 'memory_use_threshold_red', 'miglog_affinity',
                   'miglogd_children', 'multi_factor_authentication', 'ndp_max_entry',
                   ...
                   'timezone', 'traffic_priority', 'traffic_priority_level',
                   ...
                   'user_server_cert', 'vdom_mode', 'vip_arp_range',
    ...
    fields = {
        ...
        "system_global": {
            ...
            "options": {
                ...
                "admin_http_connection_receive_timeout": {"required": False, "type": "int"},
                ...
                "fortitoken_cloud_service": {"required": False, "type": "str",
                                             "choices": ["enable", "disable"]},
                ...
                "ip_src_port_range": {"required": True, "type": "str"},
                ...
                "reset_sessionless_tcp": {"required": False, "type": "str",
                                          "choices": ["enable", "disable"]},
                "restart_time": {"required": True, "type": "str"},
                ...
                "timezone": {"required": True, "type": "str",
                             "choices": ["01", "02", "03",
                                         ...
                                         "82", "73", "86",
                                         "76"]},
                "traffic_priority": {"required": True, "type": "str",
                                     "choices": ["tos", "dscp"]},
                "traffic_priority_level": {"required": True, "type": "str",
                ...
                "vdom_mode": {"required": False, "type": "str",
                              "choices": ["no-vdom", "split-vdom", "multi-vdom"]},
