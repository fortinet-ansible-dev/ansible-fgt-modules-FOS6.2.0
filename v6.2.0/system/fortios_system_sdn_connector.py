...
def filter_system_sdn_connector_data(json):
    option_list = ['access_key', 'azure_region', 'client_id',
                   ...
                   'external_ip', 'gcp_project', 'ha_status',
                   'key_passwd', 'login_endpoint', 'name',
                   'nic', 'oci_cert', 'oci_fingerprint',
                   'oci_region', 'password', 'private_key',
                   'region', 'resource_group', 'resource_url',
                   'route', 'route_table', 'secret_key',
                   'secret_token', 'server', 'server_port',
    ...
    fields = {
        ...
        "system_sdn_connector": {
            ...
            "options": {
                ...
                "ha_status": {"required": True, "type": "str",
                ...
                "nic": {"required": False, "type": "list",
                        "options": {
                            "ip": {"required": False, "type": "list",
                                   "options": {
                                       "name": {"required": True, "type": "str"},
                                       "public_ip": {"required": True, "type": "str"}
                                   }},
                            "name": {"required": True, "type": "str"}
                        }},
                "oci_cert": {"required": False, "type": "str"},
                "oci_fingerprint": {"required": False, "type": "str"},
                "oci_region": {"required": True, "type": "str",
                               "choices": ["phoenix", "ashburn", "frankfurt",
                                           "london", "toronto"]},
                "password": {"required": True, "type": "password_aes256"},
                ...
                "secret_token": {"required": True, "type": "str"},
                "server": {"required": True, "type": "str"},
                "server_port": {"required": False, "type": "int"},
                "service_account": {"required": True, "type": "str"},
                ...
                "type": {"required": True, "type": "str",
                         "choices": ["aci", "alicloud", "aws",
                                     "azure", "gcp", "nsx",
                                     "nuage", "oci", "openstack",
                                     "kubernetes", "vmware"]},
                "update_interval": {"required": False, "type": "int"},
                "use_metadata_iam": {"required": True, "type": "str",
                                     "choices": ["disable", "enable"]},
