...
def filter_web_proxy_global_data(json):
    option_list = ['fast_policy_match', 'forward_proxy_auth', 'forward_server_affinity_timeout',
                   ...
                   'max_waf_body_cache_length', 'proxy_fqdn', 'ssl_ca_cert',
                   'ssl_cert', 'strict_web_check', 'tunnel_non_http',
                   'unknown_http_version', 'webproxy_profile']
    dictionary = {}
    ...
    fields = {
        ...
        "web_proxy_global": {
            ...
            "options": {
                ...
                "proxy_fqdn": {"required": True, "type": "str"},
