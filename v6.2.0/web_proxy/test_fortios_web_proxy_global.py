...
def test_web_proxy_global_creation(mocker):
    ...
    input_data = {
        ...
        'web_proxy_global': {
            ...
            'ssl_ca_cert': 'test_value_12',
            'ssl_cert': 'test_value_13',
            'strict_web_check': 'enable',
            'tunnel_non_http': 'enable',
            'unknown_http_version': 'reject',
            'webproxy_profile': 'test_value_17'
        },
        'vdom': 'root'}
    ...
    expected_data = {
        ...
        'ssl-ca-cert': 'test_value_12',
        'ssl-cert': 'test_value_13',
        'strict-web-check': 'enable',
        'tunnel-non-http': 'enable',
        'unknown-http-version': 'reject',
        'webproxy-profile': 'test_value_17'
    }
