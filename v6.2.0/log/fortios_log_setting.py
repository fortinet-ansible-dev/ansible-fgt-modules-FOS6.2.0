...
def filter_log_setting_data(json):
    option_list = ['brief_traffic_format', 'custom_log_fields', 'daemon_log',
                   'expolicy_implicit_log', 'faz_override', 'fwpolicy_implicit_log',
                   'fwpolicy6_implicit_log', 'local_in_allow', 'local_in_deny_broadcast',
                   'local_in_deny_unicast', 'local_out', 'log_invalid_packet',
                   'log_policy_comment', 'log_policy_name', 'log_user_in_upper',
                   'neighbor_event', 'resolve_ip', 'resolve_port',
                   'syslog_override', 'user_anonymize']
    dictionary = {}
        ...
        "log_setting": {
            ...
            "options": {
                ...
                "expolicy_implicit_log": {"required": False, "type": "str",
                                          "choices": ["enable", "disable"]},
                "faz_override": {"required": False, "type": "str",
                                 "choices": ["enable", "disable"]},
                ...
                "resolve_port": {"required": False, "type": "str",
                                 "choices": ["enable", "disable"]},
                "syslog_override": {"required": False, "type": "str",
                                    "choices": ["enable", "disable"]},
