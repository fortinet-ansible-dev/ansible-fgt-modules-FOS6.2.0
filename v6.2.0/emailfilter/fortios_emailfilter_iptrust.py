...
def emailfilter_iptrust(data, fos):
    vdom = data['vdom']
    state = data['state']
    emailfilter_iptrust_data = data['emailfilter_iptrust']
    filtered_data = underscore_to_hyphen(filter_emailfilter_iptrust_data(emailfilter_iptrust_data))
...
def fortios_emailfilter(data, fos):
    ...
    if data['emailfilter_iptrust']:
        resp = emailfilter_iptrust(data, fos)
        ...
        "emailfilter_iptrust": {
            ...
            "options": {
                ...
                "entries": {"required": False, "type": "list",
                            "options": {
                                "addr_type": {"required": True, "type": "str",
                                              "choices": ["ipv4", "ipv6"]},
                                "id": {"required": True, "type": "int"},
                                "ip4_subnet": {"required": True, "type": "str"},
                                "ip6_subnet": {"required": True, "type": "str"},
