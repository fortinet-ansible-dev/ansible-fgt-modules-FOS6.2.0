...
def filter_switch_controller_auto_config_policy_data(json):
    option_list = ['name', 'poe_status', 'qos_policy',
                   'storm_control_policy']
    dictionary = {}
...
def switch_controller_auto_config_policy(data, fos):
    vdom = data['vdom']
    state = data['state']
    switch_controller_auto_config_policy_data = data['switch_controller_auto_config_policy']
    filtered_data = underscore_to_hyphen(filter_switch_controller_auto_config_policy_data(switch_controller_auto_config_policy_data))
...
def fortios_switch_controller_auto_config(data, fos):
    ...
    if data['switch_controller_auto_config_policy']:
        resp = switch_controller_auto_config_policy(data, fos)
