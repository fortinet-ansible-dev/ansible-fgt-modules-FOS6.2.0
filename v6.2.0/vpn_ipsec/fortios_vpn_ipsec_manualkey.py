...
def vpn_ipsec_manualkey(data, fos):
    ...
    if 'state' in data and data['state']:
        state = data['state']
    elif 'state' in data['vpn_ipsec_manualkey'] and data['vpn_ipsec_manualkey']['state']:
    ...
    fields = {
        ...
        "vpn_ipsec_manualkey": {
            ...
            "options": {
                "state": {"required": False, "type": "str",
                          "choices": ["present", "absent"]},
                "authentication": {"required": True, "type": "str",
                                   "choices": ["null", "md5", "sha1",
                                               "sha256", "sha384", "sha512"]},
                "authkey": {"required": True, "type": "str"},
                "enckey": {"required": True, "type": "str"},
                "encryption": {"required": True, "type": "str",
                ...
                "localspi": {"required": True, "type": "str"},
                "name": {"required": True, "type": "str"},
                "remote_gw": {"required": True, "type": "str"},
                "remotespi": {"required": True, "type": "str"}
