...
def filter_vpn_ipsec_phase1_interface_data(json):
    option_list = ['acct_verify', 'add_gw_route', 'add_route',
                   ...
                   'eap', 'eap_exclude_peergrp', 'eap_identity',
                   'encap_local_gw4', 'encap_local_gw6', 'encap_remote_gw4',
                   'encap_remote_gw6', 'encapsulation', 'encapsulation_address',
                   'enforce_unique_id', 'exchange_interface_ip', 'exchange_ip_addr4',
                   'exchange_ip_addr6', 'fec_base', 'fec_egress',
                   'fec_ingress', 'fec_receive_timeout', 'fec_redundant',
                   ...
                   'ip_fragmentation', 'ip_version', 'ipv4_dns_server1',
                   ...
                   'local_gw6', 'localid', 'localid_type',
                   'mesh_selector_type', 'mode', 'mode_cfg',
                   'monitor', 'monitor_hold_down_delay', 'monitor_hold_down_time',
                   'monitor_hold_down_type', 'monitor_hold_down_weekday', 'name',
                   'nattraversal', 'negotiate_timeout', 'net_device',
                   'network_id', 'network_overlay', 'passive_mode',
                   'peer', 'peergrp', 'peerid',
        ...
        "vpn_ipsec_phase1_interface": {
            ...
            "options": {
                ...
                "authmethod_remote": {"required": False, "type": "str",
                                      "choices": ["psk", "signature"]},
                "authpasswd": {"required": True, "type": "str"},
                "authusr": {"required": True, "type": "str"},
                ...
                "cert_id_validation": {"required": False, "type": "str",
                                       "choices": ["enable", "disable"]},
                "certificate": {"required": True, "type": "list",
                                "options": {
                ...
                "eap": {"required": False, "type": "str",
                        "choices": ["enable", "disable"]},
                "eap_exclude_peergrp": {"required": False, "type": "str"},
                "eap_identity": {"required": False, "type": "str",
                                 "choices": ["use-id-payload", "send-request"]},
                "encap_local_gw4": {"required": True, "type": "str"},
                "encap_local_gw6": {"required": True, "type": "str"},
                "encap_remote_gw4": {"required": True, "type": "str"},
                "encap_remote_gw6": {"required": True, "type": "str"},
                ...
                "fec_base": {"required": False, "type": "int"},
                "fec_egress": {"required": False, "type": "str",
                               "choices": ["enable", "disable"]},
                "fec_ingress": {"required": False, "type": "str",
                                "choices": ["enable", "disable"]},
                "fec_receive_timeout": {"required": False, "type": "int"},
                "fec_redundant": {"required": False, "type": "int"},
                "fec_send_timeout": {"required": False, "type": "int"},
                ...
                "group_authentication": {"required": False, "type": "str",
                                         "choices": ["enable", "disable"]},
                "group_authentication_secret": {"required": True, "type": "str"},
                ...
                "ip_fragmentation": {"required": False, "type": "str",
                ...
                "ipv4_end_ip": {"required": True, "type": "str"},
                "ipv4_exclude_range": {"required": False, "type": "list",
                                       "options": {
                                           "end_ip": {"required": True, "type": "str"},
                                           "id": {"required": True, "type": "int"},
                                           "start_ip": {"required": True, "type": "str"}
                                       }},
                ...
                "ipv4_start_ip": {"required": True, "type": "str"},
                ...
                "ipv6_end_ip": {"required": True, "type": "str"},
                ...
                "ipv6_start_ip": {"required": True, "type": "str"},
                ...
                "monitor_hold_down_delay": {"required": True, "type": "int"},
                "monitor_hold_down_time": {"required": True, "type": "str"},
                "monitor_hold_down_type": {"required": False, "type": "str",
                                           "choices": ["immediate", "delay", "time"]},
                "monitor_hold_down_weekday": {"required": True, "type": "str",
                ...
                "net_device": {"required": True, "type": "str",
                               "choices": ["enable", "disable"]},
                "network_id": {"required": True, "type": "int"},
                "network_overlay": {"required": False, "type": "str",
                                    "choices": ["disable", "enable"]},
                "passive_mode": {"required": False, "type": "str",
                                 "choices": ["enable", "disable"]},
                "peer": {"required": True, "type": "str"},
                "peergrp": {"required": True, "type": "str"},
                "peerid": {"required": True, "type": "str"},
                ...
                "ppk_secret": {"required": True, "type": "str"},
                "priority": {"required": False, "type": "int"},
                "proposal": {"required": True, "type": "list",
                ...
                "psksecret_remote": {"required": True, "type": "str"},
                "reauth": {"required": False, "type": "str",
                           "choices": ["disable", "enable"]},
                "rekey": {"required": False, "type": "str",
                          "choices": ["enable", "disable"]},
                "remote_gw": {"required": True, "type": "str"},
                "remote_gw6": {"required": True, "type": "str"},
                "remotegw_ddns": {"required": True, "type": "str"},
                ...
                "send_cert_chain": {"required": False, "type": "str",
                                    "choices": ["enable", "disable"]},
                "signature_hash_alg": {"required": True, "type": "str",
