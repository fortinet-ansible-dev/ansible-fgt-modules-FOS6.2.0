...
def filter_vpn_ipsec_phase1_data(json):
    option_list = ['acct_verify', 'add_gw_route', 'add_route',
                   ...
                   'enforce_unique_id', 'fec_base', 'fec_egress',
...
def vpn_ipsec_phase1(data, fos):
    ...
    if 'state' in data and data['state']:
        state = data['state']
    elif 'state' in data['vpn_ipsec_phase1'] and data['vpn_ipsec_phase1']['state']:
    ...
    fields = {
        ...
        "vpn_ipsec_phase1": {
            ...
            "options": {
                ...
                "proposal": {"required": True, "type": "str",
