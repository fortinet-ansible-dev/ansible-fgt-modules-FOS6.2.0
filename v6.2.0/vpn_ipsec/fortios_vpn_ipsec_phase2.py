...
def filter_vpn_ipsec_phase2_data(json):
    option_list = ['add_route', 'auto_negotiate', 'comments',
                   ...
                   'encapsulation', 'ipv4_df', 'keepalive',
                   'keylife_type', 'keylifekbs', 'keylifeseconds',
                   'l2tp', 'name', 'pfs',
                   'phase1name', 'proposal', 'protocol',
                   'replay', 'route_overlap', 'selector_match',
                   'single_source', 'src_addr_type', 'src_end_ip',
                   'src_end_ip6', 'src_name', 'src_name6',
                   'src_port', 'src_start_ip', 'src_start_ip6',
                   'src_subnet', 'src_subnet6', 'use_natip']
    dictionary = {}
    ...
    fields = {
        ...
        "vpn_ipsec_phase2": {
            ...
            "options": {
                ...
                "dst_name": {"required": True, "type": "str"},
                "dst_name6": {"required": True, "type": "str"},
                ...
                "src_name": {"required": True, "type": "str"},
                "src_name6": {"required": True, "type": "str"},
