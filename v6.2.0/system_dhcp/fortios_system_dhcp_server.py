...
def system_dhcp_server(data, fos):
    ...
    if 'state' in data and data['state']:
        state = data['state']
    elif 'state' in data['system_dhcp_server'] and data['system_dhcp_server']['state']:
    ...
    fields = {
        ...
        "system_dhcp_server": {
            ...
            "options": {
                ...
                "netmask": {"required": True, "type": "str"},
                ...
                "reserved_address": {"required": False, "type": "list",
                                     "options": {
                                         ...
                                         "circuit_id": {"required": False, "type": "str"},
                                         "circuit_id_type": {"required": False, "type": "str",
                                                             "choices": ["hex", "string"]},
                                         "description": {"required": False, "type": "str"},
                                         "id": {"required": True, "type": "int"},
                                         "ip": {"required": True, "type": "str"},
                                         "mac": {"required": True, "type": "str"},
                                         "remote_id": {"required": False, "type": "str"},
                                         "remote_id_type": {"required": False, "type": "str",
                                                            "choices": ["hex", "string"]},
                                         "type": {"required": False, "type": "str",
                ...
                "tftp_server": {"required": False, "type": "list",
                                "options": {
                                    "tftp_server": {"required": True, "type": "str"}
                                }},
                ...
                "vci_string": {"required": False, "type": "list",
                               "options": {
                                   "vci_string": {"required": True, "type": "str"}
                               }},
