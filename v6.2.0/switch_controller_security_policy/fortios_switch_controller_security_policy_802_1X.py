...
def filter_switch_controller_security_policy_802_1X_data(json):
    option_list = ['auth_fail_vlan', 'auth_fail_vlan_id', 'auth_fail_vlanid',
                   'eap_passthru', 'framevid_apply', 'guest_auth_delay',
                   'guest_vlan', 'guest_vlan_id', 'guest_vlanid',
                   'mac_auth_bypass', 'name', 'open_auth',
                   'policy_type', 'radius_timeout_overwrite', 'security_mode',
                   'user_group']
    dictionary = {}
    ...
    fields = {
        ...
        "switch_controller_security_policy_802_1X": {
            ...
            "options": {
                ...
                "user_group": {"required": True, "type": "list",
                               "options": {
                                   "name": {"required": True, "type": "str"}
                               }}
