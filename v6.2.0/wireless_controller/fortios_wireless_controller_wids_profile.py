...
def wireless_controller_wids_profile(data, fos):
    ...
    if 'state' in data and data['state']:
        state = data['state']
    elif 'state' in data['wireless_controller_wids_profile'] and data['wireless_controller_wids_profile']['state']:
            ...
            "options": {
                ...
                "ap_bgscan_disable_day": {"required": False, "type": "str",
                                          "choices": ["sunday", "monday", "tuesday",
                                                      ...
                                                      "saturday"]},
                "ap_bgscan_disable_end": {"required": True, "type": "str"},
                "ap_bgscan_disable_start": {"required": True, "type": "str"},
