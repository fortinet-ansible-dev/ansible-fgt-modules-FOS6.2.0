...
def filter_wireless_controller_qos_profile_data(json):
    option_list = ['bandwidth_admission_control', 'bandwidth_capacity', 'burst',
                   ...
                   'uplink_sta', 'wmm', 'wmm_be_dscp',
                   'wmm_bk_dscp', 'wmm_dscp_marking', 'wmm_uapsd',
                   'wmm_vi_dscp', 'wmm_vo_dscp']
    dictionary = {}
        ...
        "wireless_controller_qos_profile": {
            ...
            "options": {
                ...
                "wmm": {"required": False, "type": "str",
                        "choices": ["enable", "disable"]},
                "wmm_be_dscp": {"required": False, "type": "int"},
                "wmm_bk_dscp": {"required": False, "type": "int"},
                "wmm_dscp_marking": {"required": False, "type": "str",
                                     "choices": ["enable", "disable"]},
                "wmm_uapsd": {"required": False, "type": "str",
                              "choices": ["enable", "disable"]},
                "wmm_vi_dscp": {"required": False, "type": "int"},
                "wmm_vo_dscp": {"required": False, "type": "int"}
