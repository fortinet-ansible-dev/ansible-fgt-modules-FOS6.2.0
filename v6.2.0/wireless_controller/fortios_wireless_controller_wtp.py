...
def filter_wireless_controller_wtp_data(json):
    option_list = ['admin', 'allowaccess', 'bonjour_profile',
                   'coordinate_latitude', 'coordinate_longitude', 'image_download',
...
def wireless_controller_wtp(data, fos):
    ...
    if 'state' in data and data['state']:
        state = data['state']
    elif 'state' in data['wireless_controller_wtp'] and data['wireless_controller_wtp']['state']:
    ...
    fields = {
        ...
        "wireless_controller_wtp": {
            ...
            "options": {
                ...
                "region_x": {"required": False, "type": "str"},
                "region_y": {"required": False, "type": "str"},
                "split_tunneling_acl": {"required": False, "type": "list",
                                        "options": {
                                            "dest_ip": {"required": True, "type": "str"},
                ...
                "wtp_id": {"required": True, "type": "str"},
                "wtp_mode": {"required": False, "type": "str",
                             "choices": ["normal", "remote"]},
                "wtp_profile": {"required": True, "type": "str"}
