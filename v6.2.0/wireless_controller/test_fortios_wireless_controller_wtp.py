...
def test_wireless_controller_wtp_creation(mocker):
    ...
    input_data = {
        ...
        'wireless_controller_wtp': {
            ...
            'coordinate_latitude': 'test_value_6',
            'coordinate_longitude': 'test_value_7',
            'image_download': 'enable',
            'index': '9',
            'ip_fragment_preventing': 'tcp-mss-adjust',
            'led_state': 'enable',
            'location': 'test_value_12',
            'login_passwd': 'test_value_13',
            ...
            'region': 'test_value_24',
            'region_x': 'test_value_25',
            'region_y': 'test_value_26',
    ...
    expected_data = {
        ...
        'coordinate-latitude': 'test_value_6',
        'coordinate-longitude': 'test_value_7',
        'image-download': 'enable',
        'index': '9',
        'ip-fragment-preventing': 'tcp-mss-adjust',
        'led-state': 'enable',
        'location': 'test_value_12',
        'login-passwd': 'test_value_13',
        ...
        'name': 'default_name_16',
                ...
                'region': 'test_value_24',
                'region-x': 'test_value_25',
                'region-y': 'test_value_26',
