...
def test_wireless_controller_vap_creation(mocker):
    ...
    input_data = {
        ...
        'wireless_controller_vap': {
            ...
            'address_group': 'test_value_4',
            'alias': 'test_value_5',
            'atf_weight': '6',
            'auth': 'psk',
            'broadcast_ssid': 'enable',
            'broadcast_suppression': 'dhcp-up',
            'captive_portal_ac_name': 'test_value_10',
            'captive_portal_macauth_radius_secret': 'test_value_11',
            'captive_portal_macauth_radius_server': 'test_value_12',
            'captive_portal_radius_secret': 'test_value_13',
            'captive_portal_radius_server': 'test_value_14',
            ...
            'external_logout': 'test_value_26',
            'external_web': 'test_value_27',
            ...
            'gtk_rekey': 'enable',
            'gtk_rekey_intv': '34',
            'hotspot20_profile': 'test_value_35',
            ...
            'max_clients': '49',
            'max_clients_ap': '50',
            'me_disable_thresh': '51',
            'mesh_backhaul': 'enable',
            'mpsk': 'enable',
            'mpsk_concurrent_clients': '54',
            ...
            'owe_transition_ssid': 'test_value_61',
            'passphrase': 'test_value_62',
            'pmf': 'disable',
            'pmf_assoc_comeback_timeout': '64',
            'pmf_sa_query_retry_timeout': '65',
            'portal_message_override_group': 'test_value_66',
            'portal_type': 'auth',
            'probe_resp_suppression': 'enable',
            'probe_resp_threshold': 'test_value_69',
            'ptk_rekey': 'enable',
            'ptk_rekey_intv': '71',
            'qos_profile': 'test_value_72',
            'quarantine': 'enable',
            'radio_2g_threshold': 'test_value_74',
            'radio_5g_threshold': 'test_value_75',
            'radio_sensitivity': 'enable',
            'radius_mac_auth': 'enable',
            'radius_mac_auth_server': 'test_value_78',
            'radius_server': 'test_value_79',
            'rates_11a': '1',
            ...
            'sae_groups': '1',
            'sae_password': 'test_value_87',
            'schedule': 'test_value_88',
            'security': 'open',
            'security_exempt_list': 'test_value_90',
            'security_obsolete_option': 'enable',
            'security_redirect_url': 'test_value_92',
            'split_tunneling': 'enable',
            'ssid': 'test_value_94',
            'tkip_counter_measure': 'enable',
            'utm_profile': 'test_value_96',
            'vlan_auto': 'enable',
    ...
    expected_data = {
        ...
        'address-group': 'test_value_4',
        'alias': 'test_value_5',
        'atf-weight': '6',
        'auth': 'psk',
                'broadcast-ssid': 'enable',
                'broadcast-suppression': 'dhcp-up',
                'captive-portal-ac-name': 'test_value_10',
                'captive-portal-macauth-radius-secret': 'test_value_11',
                'captive-portal-macauth-radius-server': 'test_value_12',
                'captive-portal-radius-secret': 'test_value_13',
                'captive-portal-radius-server': 'test_value_14',
                'captive-portal-session-timeout-interval': '15',
                'dhcp-lease-time': '16',
                ...
                'external-logout': 'test_value_26',
                'external-web': 'test_value_27',
                'fast-bss-transition': 'disable',
                'fast-roaming': 'enable',
                'ft-mobility-domain': '30',
                'ft-over-ds': 'disable',
                'ft-r0-key-lifetime': '32',
                'gtk-rekey': 'enable',
                'gtk-rekey-intv': '34',
                'hotspot20-profile': 'test_value_35',
                ...
                'max-clients': '49',
                'max-clients-ap': '50',
                'me-disable-thresh': '51',
                'mesh-backhaul': 'enable',
                'mpsk': 'enable',
                'mpsk-concurrent-clients': '54',
                ...
                'owe-transition-ssid': 'test_value_61',
                'passphrase': 'test_value_62',
                'pmf': 'disable',
                'pmf-assoc-comeback-timeout': '64',
                'pmf-sa-query-retry-timeout': '65',
                'portal-message-override-group': 'test_value_66',
                'portal-type': 'auth',
                'probe-resp-suppression': 'enable',
                'probe-resp-threshold': 'test_value_69',
                'ptk-rekey': 'enable',
                'ptk-rekey-intv': '71',
                'qos-profile': 'test_value_72',
                'quarantine': 'enable',
                'radio-2g-threshold': 'test_value_74',
                'radio-5g-threshold': 'test_value_75',
                'radio-sensitivity': 'enable',
                'radius-mac-auth': 'enable',
                'radius-mac-auth-server': 'test_value_78',
                'radius-server': 'test_value_79',
                'rates-11a': '1',
                ...
                'sae-groups': '1',
                'sae-password': 'test_value_87',
                'schedule': 'test_value_88',
                'security': 'open',
                'security-exempt-list': 'test_value_90',
                'security-obsolete-option': 'enable',
                'security-redirect-url': 'test_value_92',
                'split-tunneling': 'enable',
                'ssid': 'test_value_94',
                'tkip-counter-measure': 'enable',
                'utm-profile': 'test_value_96',
                'vlan-auto': 'enable',
