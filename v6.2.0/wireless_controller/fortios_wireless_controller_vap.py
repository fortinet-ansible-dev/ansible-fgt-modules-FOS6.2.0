...
options:
    ...
    wireless_controller_vap:
        ...
        suboptions:
            ...
            schedule:
                description:
                    - VAP schedule name. Source firewall.schedule.recurring.name.
                type: str
            security:
                description:
...
def filter_wireless_controller_vap_data(json):
    option_list = ['acct_interim_interval', 'address_group', 'alias',
                   'atf_weight', 'auth', 'broadcast_ssid',
                   'broadcast_suppression', 'captive_portal_ac_name', 'captive_portal_macauth_radius_secret',
                   ...
                   'dhcp_option82_insertion', 'dhcp_option82_remote_id_insertion', 'dynamic_vlan',
                   'eap_reauth', 'eap_reauth_intv', 'eapol_key_retries',
                   'encrypt', 'external_fast_roaming', 'external_logout',
                   'external_web', 'fast_bss_transition', 'fast_roaming',
                   'ft_mobility_domain', 'ft_over_ds', 'ft_r0_key_lifetime',
                   'gtk_rekey', 'gtk_rekey_intv', 'hotspot20_profile',
                   'intra_vap_privacy', 'ip', 'key',
                   'keyindex', 'ldpc', 'local_authentication',
                   'local_bridging', 'local_lan', 'local_standalone',
                   'local_standalone_nat', 'mac_auth_bypass', 'mac_filter',
                   'mac_filter_list', 'mac_filter_policy_other', 'max_clients',
                   'max_clients_ap', 'me_disable_thresh', 'mesh_backhaul',
                   'mpsk', 'mpsk_concurrent_clients', 'mpsk_key',
                   'multicast_enhance', 'multicast_rate', 'name',
                   'okc', 'owe_groups', 'owe_transition',
                   'owe_transition_ssid', 'passphrase', 'pmf',
                   'pmf_assoc_comeback_timeout', 'pmf_sa_query_retry_timeout', 'portal_message_override_group',
                   'portal_message_overrides', 'portal_type', 'probe_resp_suppression',
                   ...
                   'security', 'security_exempt_list', 'security_obsolete_option',
                   'security_redirect_url', 'selected_usergroups', 'split_tunneling',
                   'ssid', 'tkip_counter_measure', 'usergroup',
            ...
            "options": {
                ...
                "broadcast_suppression": {"required": False, "type": "str",
                                          "choices": ["dhcp-up", "dhcp-down", "dhcp-starvation",
                                                      "dhcp-ucast", "arp-known", "arp-unknown",
                                                      "arp-reply", "arp-poison", "arp-proxy",
                                                      "netbios-ns", "netbios-ds", "ipv6",
                ...
                "mpsk_key": {"required": False, "type": "list",
                             "options": {
                                 ...
                                 "key_name": {"required": True, "type": "str"},
                ...
                "security": {"required": False, "type": "str",
                             "choices": ["open", "captive-portal", "wep64",
                                         ...
                                         "wpa2-only-enterprise", "wpa3-enterprise", "wpa3-sae",
                                         "wpa3-sae-transition", "owe", "osen"]},
